          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="text-center lg:text-left">
              <h3 className="text-2xl md:text-3xl font-bold mb-2">
                Join our <span className="text-[#d2ff1f]">newsletter</span>
              </h3>
            ...
            <form onSubmit={handleSubmit} className="flex w-full max-w-md">
              <input
                ...
                className="flex-1 px-5 py-3.5 bg-white/10 border border-white/20 rounded-l-full text-white placeholder:text-white/40 focus:outline-none focus:border-[#d2ff1f] transition-colors"
                required
              />
              <button
                type="submit"
                className="px-8 py-3.5 bg-[#d2ff1f] text-black font-semibold rounded-r-full hover:bg-[#c4f018] transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <h2 className="text-2xl font-bold mb-4">
              <span className="text-[#d2ff1f]">ELA</span>RO
            </h2>
            <p className="text-white/60 text-sm leading-relaxed mb-6 max-w-sm">
              Premium fashion and lifestyle products curated for the modern individual.
              Discover unique pieces from independent sellers worldwide.
            </p>
            {/* Social Icons */}
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#d2ff1f] hover:text-black transition-all duration-300"
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#35b9e9] transition-all duration-300"
                aria-label="Twitter"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            <h3 className="text-sm font-semibold text-[#d2ff1f] mb-4 uppercase tracking-wider">
              Customer Services
            </h3>
            <nav className="space-y-3" aria-label="Customer services navigation">
              {footerLinks.customerServices.map(({ label, path }) => (
                <LocalizedClientLink
                  key={label}
                  href={path}
                  className="block text-sm text-white/60 hover:text-white hover:translate-x-1 transition-all duration-200"
                >
                  {label}
                </LocalizedClientLink>
              ))}
          ...
          {/* About Column */}
          <div>
            <h3 className="text-sm font-semibold text-[#35b9e9] mb-4 uppercase tracking-wider">
              About
            </h3>
